...
## [Introduction](https://gchism94.github.io/rrtools-repro-research/intro.html)

Introduction to the workshop and what you can expect to take away

------------------------------------------------------------------------

## [**Create a Research Compendium**](https://gchism94.github.io/rrtools-repro-research/create-compendium.html)

Create a template Research Compendium from **`rrtools`**

------------------------------------------------------------------------

## [**Manage functionality as a package**](https://gchism94.github.io/rrtools-repro-research/manage-as-package.html)

Make your Compendium an R Package to ensure reproducibility

------------------------------------------------------------------------

## [Reproduce a paper with Distill](https://gchism94.github.io/rrtools-repro-research/reproduce-distill-paper.html)
