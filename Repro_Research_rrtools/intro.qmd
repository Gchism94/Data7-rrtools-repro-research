...
[![](https://blog.ml.cmu.edu/wp-content/uploads/2019/11/2.png)](https://doi.org/10.1038/533452a)
...
1.  \_Wickham, H. (2017) [Research compendia. Note prepared for the 2017 rOpenSci Unconf\_](https://docs.google.com/document/d/1LzZKS44y4OEJa4Azg5reGToNAZL0e0HSUwxamNY7E-Y/edit#heading=h.blggi16hdosp)
...
![*Example use of the R package structure for a research compendium* [@marwick2018]](https://annakrystalli.me/rrtools-repro-research/assets/marw_f3.jpeg){width="360"}
...
#### On github: [https://github.com/gchism/rrtools-wkshp-materials/](https://github.com/Gchism94/rrtools-repro-research){.uri}

-   Click on **Fork**

-   Click on **Clone** within the new repository

-   Copy the **HTTPS URL**

-   Start a new **RStudio Project** in RStudio Cloud using **Version control**
