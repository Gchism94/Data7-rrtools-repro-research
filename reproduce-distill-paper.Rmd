...
Scientific and technical writing is generally written using Word, or Google Docs. Think about whether you could reproduce these formats without copy and paste. You could always use LaTeX, but you'd have to learn the syntax.
...
```{r echo = TRUE, output = FALSE, eval = TRUE}
...
```{r, echo = TRUE, eval = FALSE, output = FALSE}
...
```{r echo = TRUE, eval = TRUE, output = TRUE}
data |>
...
```{r echo = FALSE, message = FALSE, eval = TRUE, output = TRUE}
data |>
...
![](https://rstudio.github.io/distill/images/article-after.png){width="1000"}
