---
title: "Reproducible research compendium through GitHub and RStudio"
author: "Greg Chism"
...
I practice **live coding** `r emo::ji("fearful")` during my workshops so that you can follow along and have your version of the R scripts.
...
In these workshops we'll **create a template research compendium** that you can use for your own research project (text, data, code).
